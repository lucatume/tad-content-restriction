...
class trc_FilteringTaxQueryGeneratorTest extends \PHPUnit_Framework_TestCase {
	...
	public function it_should_be_instantiatable() {
		Test::assertInstanceOf( 'trc_FilteringTaxQueryGenerator', new trc_FilteringTaxQueryGenerator() );
	}
