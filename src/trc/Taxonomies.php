...
class trc_Taxonomies implements trc_RestrictingTaxonomiesInterface {
	...
	public function get_restricting_taxonomies( $post_type ) {
		...
		$taxonomies = array_intersect( $this->taxonomies, get_taxonomies( array( 'object_type' => $post_type ) ) );

		return apply_filters( 'trc_restricting_taxonomies', $taxonomies, $post_type );
	}
